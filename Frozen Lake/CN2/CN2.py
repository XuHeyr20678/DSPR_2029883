...
if __name__ == "__main__":
    ...
    rules = cn2.fit('class_train.csv')
    train_end = time.time()
    print('Training time: ', train_end - train_start, ' s')
    print('Rules:')
    cn2.print_rules(rules)

    with open('../Data/output/class_rules', 'wb') as f:
        pickle.dump(rules, f)
    ...
    rules_performance, accuracy = cn2.predict('class_test.csv', rules)
    ...
    with pd.option_context('display.max_rows', None, 'display.max_columns', None):
        print(table)
    table.to_csv('../Data/output/class_performance.csv')
...
'''
    ...
    cn2 = CN2()
    train_start = time.time()
    rules = cn2.fit('range_train.csv')
    train_end = time.time()
    print('Training time: ', train_end - train_start, ' s')
    print('Rules:')
    cn2.print_rules(rules)

    with open('../Data/output/range_rules', 'wb') as f:
        pickle.dump(rules, f)
    ...
    rules_performance, accuracy = cn2.predict('range_test.csv', rules)
    print('Accuracy: ', accuracy)
    print('Testing performance:')
    keys = []
    vals = []
    ...
    with pd.option_context('display.max_rows', None, 'display.max_columns', None):
        print(table)
    table.to_csv('../Data/output/range_performance.csv')
'''
